    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Experience lightning-fast peer-to-peer file sharing with end-to-end encryption. Your files never touch our servers, ensuring complete privacy." />
