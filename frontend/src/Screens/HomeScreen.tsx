...
function HomeScreen() {
  ...
  return (
    <>
      <Helmet>
        <title>PeerDrop | Home</title>
        <meta
          name="description"
          content="Experience lightning-fast peer-to-peer file sharing with end-to-end encryption. Your files never touch our servers, ensuring complete privacy."
        />
      ...
      <div
        ref={targetRef}
        className="min-h-screen bg-[#0E0E0E] text-[#D9D9D9] relative overflow-hidden"
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-16">
          <motion.div style={{ opacity, scale }} className="text-center mb-24">
            <motion.div
              ...
              className="mb-8"
            >
              <h2 className="text-[#FFD700] text-xl mb-4">
                SECURE FILE SHARING
              </h2>
              <motion.h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-[#FFD700] via-[#FFA500] to-[#A020F0] bg-clip-text text-transparent">
                Share Files Instantly
              </motion.h1>
              <motion.p className="text-xl md:text-2xl mb-6 text-[#D9D9D9]/90">
                No limits. No sign-up. Just share.
              </motion.p>
              <motion.p className="text-lg text-[#D9D9D9]/70 max-w-2xl mx-auto">
                Experience lightning-fast peer-to-peer file sharing with
                end-to-end encryption. Your files never touch our servers,
