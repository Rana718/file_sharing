      ...
      >
         ...
         {transferStatus === "waiting" && (
            ...
            >
               ...
               <p className="text-[#D9D9D9]/60">
                  Sender will send files shortly
               </p>
         ...
         {transferStatus === "receiving" && (
            ...
            >
               ...
               {relativePath && relativePath !== fileName && (
                  <p className="text-xs text-[#D9D9D9]/60 break-all">
                     Path: {relativePath}
                  </p>
               )}
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-[#D9D9D9]/70">
                  <p>
                     Data: {formatFileSize(receivedBytes)} /{" "}
         ...
         {transferStatus === "completed" && receivedFile && (
            ...
            >
               ...
               >
                  File received successfully. Click Download File.
               </motion.p>
            </motion.div>
         )}
      </motion.div>
